...
translate traditional_chinese strings:
    ...
    new "未連接到Lovense玩具。請在遊戲偏好設置中檢查連接。"
    ...
    new "使用Android和iOS版{i}Lovense Remote{/i}應用獲取連接玩具所需的IP地址與端口。請確保運行{i}Tales From The Unending Void{/i}的設備和{i}Lovense Remote{/i}應用均已連接至同一網絡(局域網)，且玩具已開機並連接到{i}Lovense Remote{/i}應用。"
    ...
    new "點擊{b}Discover{/b}標籤頁並啓用{b}Game Mode{/b}，可在{i}Lovense Remote{/i}應用中獲取連接IP地址與端口。請將{i}Lovense Remote{/i}應用中顯示的IP及端口填入本界面右側。"
    ...
    new "訪問{i}Lovense.com{/i}訂購玩具，以全新的方式體驗{i}無盡虛空傳說{/i}。"
