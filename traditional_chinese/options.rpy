...
translate traditional_chinese strings:
    ...
    new "Grubb {i}(葡萄牙語){/i}, MyPrettyWolfy {i}(俄語){/i}, Rory Mercury91 (法語), Frank Rosario {i}(意大利語){/i}, Freeman {i}(波蘭語, 部分){/i}, Juan Manuel and Kabezon {i}(西班牙語, 部分){/i}"
    ...
    new "感謝HoboCop86、ThunderRob、Philipp、Boerke、Dreamweaver、Alorth、marcurion、Ravendarklocks、gamersglory、GhostPhil、Grubb、Freki和Razielprince進行測試。\n\n給我的頂級支持者們大大的感謝。你們太棒了！過去和現在的贊助者包括：\n{i}"
