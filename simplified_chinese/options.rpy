...
translate simplified_chinese strings:
    ...
    new "Grubb {i}(葡萄牙语){/i}, MyPrettyWolfy {i}(俄语){/i}, Rory Mercury91 (法语), Frank Rosario {i}(意大利语){/i}, Freeman {i}(波兰语, 部分){/i}, Juan Manuel and Kabezon {i}(西班牙语, 部分){/i}"
    ...
    new "感谢HoboCop86、ThunderRob、Philipp、Boerke、Dreamweaver、Alorth、marcurion、Ravendarklocks、gamersglory、GhostPhil、Grubb、Freki和Razielprince进行测试。\n\n给我的顶级支持者们大大的感谢。你们太棒了！过去和现在的赞助者包括：\n{i}"
