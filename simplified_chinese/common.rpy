...
translate simplified_chinese strings:
    ...
    new "无障碍菜单。使用上下方向键导航，按回车键启用按钮和进度条。"
    ...
    new "本菜单选项旨在提升无障碍体验。这些选项可能不适用于所有游戏，且某些组合可能导致游戏无法运行。此问题非游戏或引擎缺陷。更改字体时建议保持原文字大小，以获得最佳效果。"
    ...
    new "点击设置变换，右键单击添加到变换列表。"

    # renpy/common/00director.rpy:1777
    old "Customize director.transforms to add more transforms."
    new "定制 director.transforms 来添加更多变换。"
    ...
    new "你确定要跳过未读对话直接到下一个选项吗？"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "该存档创建于其他设备。恶意构造的存档文件可能损害计算机。你是否信任该存档创建者及所有可能修改过文件的人？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "你是否信任创建存档的设备？仅当你是该设备唯一用户时才应选\"是\"。"
    ...
    new "本程序包含遵循多种许可协议的免费软件，包括MIT许可证和GNU宽通用公共许可证。完整的软件列表及源代码链接可在此处查看{a=https://www.renpy.org/l/license}here{/a}。"
    ...
    new "剪贴板朗读功能已启用。按 'shift+C' 键来禁用。"

    # renpy/common/00preferences.rpy:703
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自助朗读功能会说 \"[renpy.display.tts.last]\"。按 'alt+shift+V' 键来禁用。"

    # renpy/common/00preferences.rpy:705
    old "Self-voicing enabled. Press 'v' to disable."
    new "自助朗读功能已启用。按 'v' 键来禁用。"
    ...
    new "Ren'Py同步服务器无此同步数据副本，可能因ID无效或同步已超时。"
    ...
    new "这会将存档上传至{a=https://sync.renpy.org}Ren'Py同步服务器{/a}。\n要继续吗？"
    ...
    new "将联系{a=https://sync.renpy.org}Ren'Py同步服务器{/a}。"
    ...
    new "可凭此ID在其他设备下载存档。\n此同步数据一小时后失效。\nRen'Py同步服务由{a=https://www.renpy.org/sponsors.html}Ren'Py赞助者{/a}提供支持。"
    ...
    new " 翻译文件 [tl.filename]：[tl.linenumber]"
    ...
    new "将traceback.txt以BBcode格式复制至剪贴板，适用于https://lemmasoft.renai.us/等论坛。"
    ...
    new "将traceback.txt以Markdown格式复制至剪贴板，适配Discord平台。"
