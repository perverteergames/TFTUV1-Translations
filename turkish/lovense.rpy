...
translate turkish strings:
    ...
    new "toy'a bağlanılamadı"


    old "Not connected to a Lovense toy. Please check your connection in the game's perferences."
    new "Lovense toy'a bağlı değil. Lütfen oyun tercihlerinden bağlantınızı kontrol edin."
    ...
    new "Oyuncağınızı {i}Lovense.com{/i}'dan sipariş edin ve {i}Tales From The Unending Void{/i}'i bambaşka bir şekilde deneyimleyin."
