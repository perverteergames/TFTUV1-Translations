...
translate italian strings:
    ...
    new "Non sei connesso a un gioco Lovense. Controlla la tua connessione nelle preferenze del gioco."
    ...
    new "Utilizza l'app {i}Lovense Remote{/i} per Android e iOS per ottenere l'indirizzo IP e la porta per connetterti al tuo giocattolo. Assicurati che sia il dispositivo su cui è in esecuzione {i}Tales From The Unending Void{/i} sia l'app {i}Lovense Remote{/i} siano connessi alla stessa rete (LAN) e che il tuo giocattolo sia acceso e connesso all'app {i}Lovense Remote{/i}."
    ...
    new "Puoi trovare l'indirizzo IP e la porta per la connessione toccando la scheda {b}Discover{/b} e attivando {b}Game Mode{/b} nell'app {i}Lovense Remote{/i}. Inserisci l'IP e la porta indicati nell'app {i}Lovense Remote{/i} sulla destra di questa schermata."
    ...
    old "Get a toy now"
    new "Prendi subito un giocattolo"
