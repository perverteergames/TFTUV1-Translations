...
translate italian strings:
    ...
    new "Grazie a HoboCop86, ThunderRob, Philipp, Boerke, Dreamweaver, Alorth, marcurion, Ravendarklocks, gamersglory, GhostPhil, Grubb, Freki e Razielprince per aver testato il gioco.\n\nUn grande ringraziamento ai miei sostenitori di alto livello. Siete fantastici! Tra i sostenitori passati e presenti figurano:\n{i}"
...
translate italian strings:
    ...
    new "Grubb {i}(Portuguese){/i}, MyPrettyWolfy {i}(Russian){/i}, Rory Mercury91 (French), Frank Rosario {i}(Italian){/i}, Freeman {i}(Polish, partial){/i}, Juan Manuel and Kabezon {i}(Spanish, partial){/i}, Donk. {i}(Turkish, darkeros.org){/i}, Bomber86 (German)"
